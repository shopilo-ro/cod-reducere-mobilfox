#!/usr/bin/env node
/**
 * Fetch coduri reducere Mobilfox de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/mobilfox.com
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/mobilfox.com";
const STORE_NAME  = "Mobilfox";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-mobilfox)" }
  });
